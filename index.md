...
venue: "St. John's"        # brief name of host site without address (e.g., "Euphoric State University")
...
instructor: ["Richard","Samuel"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Samuel","Richard"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
